...
@author: MinjeongKang
"""
# code description: Growth curve fitting for a 16-multi-well plate using the Gompertz model.
...
for i in temp:
    ...
    OD_read[16].append(float(i.split(',')[16][:-1]))
...
for i in range(1,17):
    ...
    print (str(bio_mu))
   #plt.show()
plt.savefig("23h_xdhB_pop_gly.pdf")